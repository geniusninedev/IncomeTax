...
public class AdvanceIncomeTaxCalculator extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.activity_advance_income_tax_calculator, null);
        ...
        Button btnClear = (Button) v.findViewById(R.id.advancetaxclear);
    ...
    private void dispalyPieChart(double incomeTaxRelief, double surcharge,double educationCess,double higherAndSecondaryEduCess) {
        ...
        mChart = (PieChart)getActivity().findViewById(R.id.advancepiechart);
