...
import com.nineinfosys.android.incometax.IncomeTaxCalculator.IncomeTaxHelp;
...
public class IncomeTaxHelpList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       Ruleslistview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent MemRef = new Intent(IncomeTaxHelpList.this, IncomeTaxHelpweb.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            finish();
            startActivity(new Intent(IncomeTaxHelpList.this, MainActivityDrawer.class));
        }
